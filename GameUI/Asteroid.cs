...
namespace GameUI
{
    ...
    public class Asteroid : Sprite
    {
        ...
        public static Vector2[] largecolliderpoints = new Vector2[34] { new Vector2(16, -71), new Vector2(30, -71), new Vector2(47, -71), new Vector2(58, -68), new Vector2(67, -66), new Vector2(74, -57), new Vector2(65, -51), new Vector2(61, -43), new Vector2(64, -32), new Vector2(71, -24), new Vector2(72, -13), new Vector2(59, -4), new Vector2(54, 6), new Vector2(51, 16), new Vector2(48, 26), new Vector2(34, 35), new Vector2(10, 48), new Vector2(1, 57), new Vector2(-9, 59), new Vector2(-25, 64), new Vector2(-33, 62), new Vector2(-47, 54), new Vector2(-56, 65), new Vector2(-62, 68), new Vector2(-76, 61), new Vector2(-82, 39), new Vector2(-77, 26), new Vector2(-74, 10), new Vector2(-77, -1), new Vector2(-61, -17), new Vector2(-51, -30), new Vector2(-37, -40), new Vector2(-22, -55), new Vector2(-8, -53), };
        //Centre -32,-25
